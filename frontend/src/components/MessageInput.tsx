    ...
    return (
        <form onSubmit={handleSubmit} className='flex flex-col gap-2 border-t border-gray-700 pt-2'>
            ...
            <div className='flex items-center gap-2'>
                ...
                <button type='submit' disabled={(!imageFile && !message.trim()) || isUploading} className='bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg transition-colors flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed text-white'>
                    {
