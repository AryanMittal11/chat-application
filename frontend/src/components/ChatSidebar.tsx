                    ...
                    showAllUser ? (
                        <div className='space-y-4 h-full'>
                            <div className='relative'>
                                ...
                                <input type='text' placeholder='Search Users...' className='w-full pl-10 pr-4 py-3 bg-gray-800 border border-gray-700 text-white placeholder-gray-400'
                                    value={searchQuery}
                            ...
                            <div className='space-y-2 overflow-y-auto h-full pb-4'>
                                {
                                    users?.filter((u) => u._id !== loggedInUser?._id && u.name.toLowerCase().includes(searchQuery.toLocaleLowerCase())).map((u) => (
                                        <button key={u._id} className='w-full text-left p-4 border border-gray-700 hover:border-gray-600 hover:bg-gray-800 rounded-lg transition-colors'>
                                            <div className='flex items-center gap-3'>
                                                <div className='relative'>
